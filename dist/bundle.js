...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = __webpack_require__(/*! E:\memory-game\src\main.js */298);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Title = __webpack_require__(/*! ./states/Title */ 302);

	var _Title2 = _interopRequireDefault(_Title);

	var _Game = __webpack_require__(/*! ./states/Game */ 303);

	var _Game2 = _interopRequireDefault(_Game);

	var _GameOver = __webpack_require__(/*! ./states/GameOver */ 304);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _class = function (_Phaser$State) {
	  ...
	  _createClass(_class, [{
	    ...
	    key: 'startGame',
	    value: function startGame(target) {
	      var playSound = false;
	      if (target.frame === 0) {
	        playSound = true;
	      }
	...
	var _class = function (_Phaser$State) {
	  ...
	  _createClass(_class, [{
	    ...
	    value: function create() {
	      ...
	      this.game.time.events.loop(_phaser2.default.Timer.SECOND, this.decreaseTime, this);
	    }
	  }, {
	    key: 'placeTiles',
	    value: function placeTiles() {
	      ...
	      for (var _i2 = 0; _i2 < this.numCols; _i2++) {
	        for (var j = 0; j < this.numRows; j++) {
	          var tile = this.game.add.button(leftSpace + _i2 * tileSpace, topSpace + j * tileSpace, 'tiles', this.showTile, this);
	          tile.frame = 10;
	    ...
	    value: function showTile(target) {
	      if (this.selectedArray.length < 2 && this.selectedArray.indexOf(target) === -1) {
	        ...
	        if (this.selectedArray.length === 2) {
	          this.game.time.events.add(_phaser2.default.Timer.SECOND, this.checkTiles, this);
	        }
	      }
	    }
	  }, {
	    ...
	    key: 'playSound',
	    value: function playSound(numberSound) {
	...
	var _class = function (_Phaser$State) {
	  ...
	  _createClass(_class, [{
	    ...
	    value: function create() {
	      ...
	      var text = this.game.add.text(this.game.width / 2, this.game.height / 2, 'GameOver \n\nYour score: ' + this.score + '\nBest score: ' + this.highScore + '\n\nTap to restart', style);
	      text.anchor.set(0.5);
