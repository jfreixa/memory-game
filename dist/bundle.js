...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = __webpack_require__(/*! /home/jfreixa/projects/memory-game/src/main.js */298);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Start = __webpack_require__(/*! ./states/Start */ 303);
	...
	var _GameOver = __webpack_require__(/*! ./states/GameOver */ 308);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Background = __webpack_require__(/*! ../sprites/Background.js */ 305);
	...
	var _class = function (_Phaser$State) {
	  ...
	  _createClass(_class, [{
	    ...
	    key: 'create',
	    value: function create() {
	      this.game.background = new _Background2.default({
	        game: this.game,
	        asset: undefined,
	        velocityX: 0
	      });

	      var titleGame = this.game.add.text(this.game.world.centerX, this.game.world.centerY - 100, 'CRACK ALIEN CODE', this.game.customStyle);

	      var buttonMusic = this.game.add.button(this.game.world.centerX - 100, this.game.world.centerY, 'soundicons', this.startGame, null, null, 0);

	      var buttonMute = this.game.add.button(this.game.world.centerX + 100, this.game.world.centerY, 'soundicons', this.startGame, null, null, 1);
	      buttonMute.isMute = true;

	      (0, _utils.centerGameObjects)([titleGame, buttonMusic, buttonMute]);
	    }
	  }, {
	    key: 'startGame',
	    value: function startGame(_ref) {
	      var isMute = _ref.isMute;

	      var playSound = isMute !== true;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _class = function (_Phaser$Sprite) {
	  ...
	  function _class(_ref) {
	    ...
	    _this.game = game;
	    _this.game.add.image(0, 0, 'background');
	    var emitter = _this.game.add.emitter(_this.game.world.centerX, _this.game.height, 2000);

	    emitter.width = _this.game.world.width;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Tiles = __webpack_require__(/*! ../sprites/Tiles.js */ 307);
	...
	var _class = function (_Phaser$State) {
	  ...
	  _createClass(_class, [{
	    key: 'init',
	    value: function init(soundActivated) {
	    ...
	    value: function create() {
	      ...
	      this.game.tiles = new _Tiles2.default({
	        game: this.game,
	        x: 0,
	        y: 0,
	        asset: 'tiles',
	      ...
	      (0, _utils.centerGameObjects)([this.game.scoreText, this.game.timeText]);

	      this.game.time.events.loop(_phaser2.default.Timer.SECOND, this.decreaseTime);
	    }
	  }, {
	    key: 'scored',
	...
	var _class = function (_Phaser$Sprite) {
	  ...
	  function _class(_ref) {
	    var game = _ref.game,
	        ...
	        asset = _ref.asset,
	        scored = _ref.scored,
	        plusTime = _ref.plusTime,
	        soundActivated = _ref.soundActivated;

	    _classCallCheck(this, _class);

	    var _this = _possibleConstructorReturn(this, (_class.__proto__ || Object.getPrototypeOf(_class)).call(this, game, x, y, asset));

	    _this.placeTiles = _this.placeTiles.bind(_this);
	    _this.calculateSpace = _this.calculateSpace.bind(_this);
	    _this.showTile = _this.showTile.bind(_this);
	    _this.checkTiles = _this.checkTiles.bind(_this);
	    _this.playSound = _this.playSound.bind(_this);

	    _this.game = game;
	    _this.scored = scored;
	    _this.plusTime = plusTime;
	    _this.soundActivated = soundActivated;

	    _this.tileSize = 80;
	    _this.numRows = 4;
	    _this.numCols = 5;
	    _this.tileSpacing = 10;
	    _this.tilesArray = [];
	    _this.selectedArray = [];
	    _this.tilesLeft = _this.numRows * _this.numCols;

	    _this.sounds = {
	      select: _this.game.add.audio('select'),
	      right: _this.game.add.audio('right'),
	      wrong: _this.game.add.audio('wrong')
	    };
	  ...
	  _createClass(_class, [{
	    ...
	    value: function placeTiles() {
	      var leftSpace = this.calculateSpace(this.game.width, this.numCols);
	      var topSpace = this.calculateSpace(this.game.height, this.numRows);
	      var tileSpace = this.tileSize + this.tileSpacing;

	      for (var i = 0; i < this.numRows * this.numCols; i++) {
	        this.tilesArray.push(Math.floor(i / 2));
	      }

	      for (var _i = 0; _i < this.numRows * this.numCols; _i++) {
	      ...
	      for (var _i2 = 0; _i2 < this.numCols; _i2++) {
	        for (var j = 0; j < this.numRows; j++) {
	          var tile = this.game.add.button(leftSpace + _i2 * tileSpace, topSpace + j * tileSpace, 'tiles', this.showTile, null, null, 10);
	          tile.value = this.tilesArray[j * this.numCols + _i2];
	        }
	      }
	    }
	  }, {
	    key: 'calculateSpace',
	    value: function calculateSpace(allowedSpace, numberTiles) {
	      return (allowedSpace - numberTiles * this.tileSize - (numberTiles - 1) * this.tileSpacing) / 2;
	    }
	  }, {
	    key: 'showTile',
	    value: function showTile(target) {
	      if (this.selectedArray.length < 2 && this.selectedArray.indexOf(target) === -1) {
	        ...
	        if (this.selectedArray.length === 2) {
	          this.game.time.events.add(_phaser2.default.Timer.SECOND * 0.5, this.checkTiles, this);
	        }
	      }
	    }
	  }, {
	...
	var _class = function (_Phaser$State) {
	  ...
	  _createClass(_class, [{
	    ...
	    value: function create() {
	      ...
	      (0, _utils.centerGameObjects)([text]);
